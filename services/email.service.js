  ...
  return `
    <div style="font-family: 'Inter', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #fff; border: 1px solid #e2e8f0; border-top: none; padding: 24px; border-radius: 0 0 8px 8px;">
        ...
        ${enlace ? `<a href="${enlace}" style="display: inline-block; margin-top: 16px; padding: 10px 20px; background: #1152d4; color: #fff; text-decoration: none; border-radius: 6px;">Ir al portal</a>` : ''}
      </div>
